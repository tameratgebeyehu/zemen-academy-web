...
export default function DownloadPage() {
  return <><InfoPage eyebrow="Android app" title="Your study plan, wherever you go." intro="Install Zemen Academy from an official source and continue learning online or offline." path="/download" tone="teal" highlights={["Free Android download", "Offline quiz access", "Official release channel"]}>
    ...
    <InfoSection title="Before you install"><p>Zemen Academy requires Android and uses internet access for sign-in, content synchronization, notifications and Premium verification. Downloaded quizzes remain available offline.</p><div className="install-facts"><div><b>Platform</b><span>Android</span></div><div><b>Price</b><span>Free download</span></div><div><b>Offline</b><span>Downloaded quizzes</span></div></div></InfoSection>
    <InfoSection title="After installation"><ol className="numbered-list"><li><span>1</span><div>Open Zemen Academy and choose your preferred language.</div></li><li><span>2</span><div>Select your grade and stream so the app shows relevant content.</div></li><li><span>3</span><div>Create an account, sign in, or continue as a guest where available.</div></li><li><span>4</span><div>Open Quizzes, choose a unit, and start online or download it for later.</div></li></ol></InfoSection>
