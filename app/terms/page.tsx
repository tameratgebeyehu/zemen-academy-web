...
export default function TermsPage() {
  return <InfoPage eyebrow="Terms of Use · Effective 8 August 2026" title="Fair rules for focused learning." intro="These terms protect students, educational content, and the reliability of Zemen Academy.">
    ...
    <InfoSection title="Premium service"><p>Premium access begins only after Zemen Academy verifies a submitted transfer. Current plans do not renew automatically. Access ends on the displayed expiration date unless another plan is approved. Students must submit truthful transfer information.</p></InfoSection>
