...
export const metadata: Metadata = { title: "Terms of Use", description: "Terms for using Zemen Academy educational services." };

export default function TermsPage() {
  return <InfoPage eyebrow="Legal · Effective 8 August 2026" title="Fair rules for focused learning." intro="These terms protect students, educational content, and the reliability of Zemen Academy.">
    ...
    <InfoSection title="Premium service"><p>Premium access begins only after Zemen Academy verifies a submitted transfer. Current plans do not renew automatically. Access ends on the displayed expiration date unless another plan is approved.</p></InfoSection>
    <InfoSection title="Offline content"><p>Downloaded questions, notes, explanations, and past papers are for the student’s personal educational use. Republishing, selling, or distributing Zemen Academy question banks is prohibited.</p></InfoSection>
