...
export default function AccountDeletionPage() {
  return <InfoPage eyebrow="Account control" title="Request account deletion." intro="Students can request deletion without sending a password, payment credential, bank information or identity document.">
